...
\begin{document}
\centerline{\large \textbf{Dr Matthew McDonnell}}
\centerline{matt@matt-mcdonnell.com}
\vspace{0.1in}
\begin{tabular*}{160mm}{l@{\extracolsep{\fill}}r}
  \textbf{LinkedIn} & \url{www.linkedin.com/in/matt-mcdonnell-5561703}\\
  \textbf{Github} & \url{https://www.github.com/mattmcd}\\
  \input{contact}
\end{tabular*}
\vspace{0.1in}
\\
...
\begin{tabular}{p{160mm}}
  ...
  Services group}{MathWorks}
    ...
    development in MATLAB was the major part of this role together with 
    providing coaching and integration advice.
    } \\
{\footnotesize
