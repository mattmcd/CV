...
\begin{tabular*}{160mm}{l@{\extracolsep{\fill}}r}
  ...
  \input{contact}
  \textbf{email} & matt@matt-mcdonell.com \\
\end{tabular*}
\vspace{0.1in}
\\
...
\begin{tabular}{p{145mm}}
\begin{itemize}
\item Goal oriented situations requiring innovative problem solving abilities and
the opportunity to further develop my technical skills, particularly those
relating to software development and mathematical modeling. 
\item A range of interesting technical challenges together with the resources
required to meet these challenges successfully. 
\item The opportunity to be involved at all levels of the process, ranging from
