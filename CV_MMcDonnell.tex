...
\begin{tabular}{p{160mm}}
  ...
  {Development of data products and business intelligence based on virtual try on technology.
   ...
   Acted as Interim Data Science Team Lead from October 2016 to
...
Deep Learning, a 5-course specialization by deeplearning.ai on Coursera. (In progress, 4 of 5 courses completed)\\
...
Python, SQL, SQLAlchemy, Pandas, NetworkX, Stan, Edward, Looker, FactSet, Bloomberg, PySpark, TensorFlow, MATLAB, 
